/// <summary>
/// We just do some graphical design here so we just need <c>System.Windows.Forms</c>
...
namespace SimpleWebBrowser
{
    ...
    class Tab : TabPage
    {
        ...
        //Variable d'instance, utile pour savoir combien d'instances on a.
        ...
        public Tab(Form obj, ToolStripItem[] historyMenu)
        {
            ...
            // In case we want to execute another instance of the app. In a separate processus
            // 
